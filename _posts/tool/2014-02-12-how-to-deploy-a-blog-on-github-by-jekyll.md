...
### 图片统一存放
图片我都放在了`/public/upload`下，所以我在插入图片的时候只要用`![xxx](https://7u2ho6.com1.z0.glb.clouddn.com/xxx)`就可以了。
...
![移动图片](https://7u2ho6.com1.z0.glb.clouddn.com/tech-trickster-move-picture.png)
